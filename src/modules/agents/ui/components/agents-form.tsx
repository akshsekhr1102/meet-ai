...
export  function AgentsForm({onSuccess, onCancel, initialValues}: AgentsFormProps) {
    const trpc = useTRPC();
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField  name="instructions" control={form.control} render={({field})=>(
                    <FormItem>
                        ...
                        <FormControl>
                            <Textarea {...field} placeholder="You are a helpful assistant that can answer questions and help with HW."/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}/>
